...
const COURSES = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Make (Integromat) & Zapier for Nigeria',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Pre-qualification document templates',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Technology stack selection for Nigeria',
      'Change management for Nigerian teams',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Product validation in Nigerian context',
      'Building an MVP under ₦500k',
            ...
            <div style={{ position: 'relative', textAlign: 'center' }}>
              ...
              <div style={{ borderTop: '1px solid var(--border)', paddingTop: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <div style={{ textAlign: 'left' }}>
                  <div className="f-display" style={{ fontSize: 12, fontWeight: 700, marginBottom: 2 }}>Suoyo Amiekumo</div>
                  <div className="f-mono" style={{ fontSize: 9, color: 'var(--muted)', letterSpacing: '.08em' }}>FOUNDER, PROSTACK NG</div>
                </div>
