    ...
    tiers: [
      {
        ...
        price: '₦15,000',
        period: '/month',
        desc: 'For freelancers and sole contractors tracking tenders. 14-day free trial included.',
        features: [
      ...
      },
      {
        ...
        price: '₦35,000',
        period: '/month',
        desc: 'For SMEs building a consistent tender pipeline with real-time alerts.',
        features: [
          'Monitor 150 tender portals',
      ...
      },
      {
        ...
        price: '₦85,000',
        period: '/month',
        desc: 'For serious bid teams covering 400+ portals with AI scoring and analytics.',
        features: [
    ...
    tiers: [
      {
        ...
        price: '₦15,000',
        period: '/month',
        desc: 'Single venue, core digital operations. 14-day free trial included.',
        features: [
          'POS & till management',
      ...
      },
      {
        ...
        price: '₦35,000',
        period: '/month',
        desc: 'Full digital ops for active venues — reconciliation, staff, and reporting.',
        features: [
      ...
      },
      {
        ...
        price: '₦85,000',
        period: '/month',
        desc: 'Full OS for high-volume clubs — VIP tables, events, and group management.',
        features: [
          'Everything in Basic',
